...
INSERT INTO ingredient (id, name, quantita, description, image) VALUES(nextval('ingredient_seq'), 'Basilico', 200, 'Foglie verdi aromatiche utilizzate soprattutto nella cucina italiana.', 'basilico.png');
...
INSERT INTO recipe (id, name, description, preparation, image, cooke_id) VALUES (nextval('recipe_seq'), 'Gumbo', 'Questa zuppa densa e ricca è una miscela deliziosa di gamberi freschi, salsiccia affumicata e il trinity creolo di sedano, peperoni e cipolle. Il segreto del suo sapore intenso risiede nel roux, una base di farina tostata che aggiunge profondità e consistenza al piatto', 'Iniziate preparando il roux: cuocete lentamente la farina in una padella fino a quando non raggiunge un colore nocciola scuro. Aggiungete il trinity creolo al roux e fate soffriggere fino a quando le verdure non diventano tenere. Aggiungete la salsiccia affumicata e continuate a cuocere per alcuni minuti. Versate il brodo di pollo, aggiungete i pomodori a pezzetti e condite con pepe di Caienna, foglie di alloro e timo fresco. Cuocete a fuoco lento per almeno un''ora, aggiungendo i gamberi negli ultimi 5-10 minuti di cottura per evitare che diventino gommosi. Servite il vostro Gumbo ben caldo su un letto di riso bianco, con una spruzzata di cipollotto fresco per un tocco finale autentico.', 'gumbo.png', 51);
...
INSERT INTO review (id, comment, cooke_id, recipe_id) VALUES (nextval('review_seq'), 'ciao', 1, 51);